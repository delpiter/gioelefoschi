        ...
        <div className="projects-container" id="projects">
            ...
            <div className="projects-grid">
                ...
                <div >
                    ...
                    <p>The project aimed to develop a <i>working IDE</i> that could store files in a server, organize them in directories and did have to support multiple programming languages. I worked mostly in the front-end side, integrating Editor in <a className="link" href="https://vuejs.org/">Vue.js</a> and providing features a VS Code-like editor has.</p>
                </div>
                <div>
                    <img src={projectErcole} className="zoom" alt="thumbnail" width="100%" />
                    <h2 className="project">Project Ercole</h2>

                    <p>The main goal was to create a software that, given a dataset containing pictures of fragments of ancient pots, <i>resemples the original pictures</i>. Two different approaches have been tested: trying to look up online for a ready-to-use solution and, in parallel, developing a procedural Python software. We eventually discovered <a href="https://github.com/Lecanyu/JigsawNet" className="link">JigsawNet</a> by Le Canyu and Li Xin - on GitHub, a CNN capable of resembling pieces of an image without knowing how the original picture would have looked like.</p>
                </div>
            </div>
        </div>
    );
